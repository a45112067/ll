...
- `m2wymu.html` — لوحة الإدارة (اسم سري منقّح عن `admin.html` لمنع الفحص الآلي): تسجيل دخول + إدارة منشورات + إعدادات موقع، تخزّن في Firestore.
